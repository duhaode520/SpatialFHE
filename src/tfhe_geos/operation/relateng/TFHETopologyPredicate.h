...
#ifndef TFHETOPOLOGYPREDICATE_H
#define TFHETOPOLOGYPREDICATE_H
...
namespace SpatialFHE::operation::relateng {
    ...
    public:
         ...
         */
        virtual TFHEBool value() const = 0;
         ...
         */
        virtual void init(const TFHEEnvelope& envA, const TFHEEnvelope& envB) {
